...
#ifndef _SCENE_GRAPH_DOCUMENT_COMPONENT_CLASS_H_
#define _SCENE_GRAPH_DOCUMENT_COMPONENT_CLASS_H_
...
public:
  ...
  virtual std::string             pluginName() const { return "SceneGraph Document"; }
...
#endif // _SCENE_GRAPH_DOCUMENT_COMPONENT_CLASS_H_
