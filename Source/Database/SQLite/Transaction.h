...
#ifndef _DATABASE_SQLITE_TRANSACTION_CLASS_H_
#define _DATABASE_SQLITE_TRANSACTION_CLASS_H_
...
public:
  ...
  Transaction ( ConnectionPtr c ) : 
    _c ( _checkConnection ( c ) ), 
    _guard ( _checkConnection ( c )->mutex() )
  {
...
#endif // _DATABASE_SQLITE_TRANSACTION_CLASS_H_
