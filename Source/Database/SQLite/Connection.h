...
class DATABASE_SQLITE_EXPORT Connection : public Usul::Base::Object
{
public:
  ...
  typedef Database::SQLite::Result Result;
...
{
  Binders binders;
  binders.push_back ( Database::SQLite::BinderTraits<T>::makeBinder ( t ) );
...
{
  Binders binders;
  binders.push_back ( Database::SQLite::BinderTraits<T1>::makeBinder ( t1 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T2>::makeBinder ( t2 ) );
  return this->_execute ( sql, binders );
}
...
inline Result::RefPtr Connection::execute ( const std::string &sql, const T1 &t1, const T2 &t2, const T3 &t3 )
{
  ...
  binders.push_back ( Database::SQLite::BinderTraits<T1>::makeBinder ( t1 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T2>::makeBinder ( t2 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T3>::makeBinder ( t3 ) );
  return this->_execute ( sql, binders );
}
...
inline Result::RefPtr Connection::execute ( const std::string &sql, const T1 &t1, const T2 &t2, const T3 &t3, const T4 &t4 )
{
  ...
  binders.push_back ( Database::SQLite::BinderTraits<T2>::makeBinder ( t2 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T3>::makeBinder ( t3 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T4>::makeBinder ( t4 ) );
  return this->_execute ( sql, binders );
}
...
inline Result::RefPtr Connection::execute ( const std::string &sql, const T1 &t1, const T2 &t2, const T3 &t3, const T4 &t4, const T5 &t5 )
{
  ...
  binders.push_back ( Database::SQLite::BinderTraits<T3>::makeBinder ( t3 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T4>::makeBinder ( t4 ) );
  binders.push_back ( Database::SQLite::BinderTraits<T5>::makeBinder ( t5 ) );
  return this->_execute ( sql, binders );
}
