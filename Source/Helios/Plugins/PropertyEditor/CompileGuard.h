...
#ifndef _PROPERTY_EDITOR_COMPILE_GUARD_H_
#define _PROPERTY_EDITOR_COMPILE_GUARD_H_

#ifndef _COMPILING_PROPERTY_EDITOR
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _PROPERTY_EDITOR_COMPILE_GUARD_H_
