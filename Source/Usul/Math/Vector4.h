...
public:
  ...
  typedef Vector4 < T, IndexType, ErrorCheckerType > ThisType;
  ...
  /////////////////////////////////////////////////////////////////////////////
  //
  //  Get the internal pointer. Needed for efficient use with OpenGL.
  //
  /////////////////////////////////////////////////////////////////////////////

  const T *getUnsafePointer() const
  {
    return _v;
  }
  ...
  template < class Pred > bool compare ( const Vector4 &v, Pred p ) const
  {
    return (
      p ( _v[0], v[0] ) &&
      p ( _v[1], v[1] ) &&
  ...
  {
    return ( p ( _v[0] ) && p ( _v[1] ) && p ( _v[2] ) && p ( _v[3] ) );
  }
